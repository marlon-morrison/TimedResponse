...
public class TimedResponse {
   public static void main(String[] args) {
      ...
      (null, "Is it justified to push everybody aside to achieve your goal? ");
      time2 = LocalDateTime.now();
      seconds2 = time2.getSecond();
      difference = seconds2 - seconds1;
      if(difference < 8)
         JOptionPane.showMessageDialog(null, "End seconds: " + seconds2 + "\nStart seconds: " + seconds1 + "\nIt took " + difference + " seconds for you to answer that was pretty quick.");
      else
         JOptionPane.showMessageDialog(null, "End seconds: " + seconds2 + "\nStart seconds: " + seconds1 + "\nIt took " + difference + " seconds for you to answer looks like it took you a minute.");
   }
}